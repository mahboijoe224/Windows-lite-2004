...
PowerShell -Command "Get-AppxPackage "Microsoft.MicrosoftEdge_44.19041.1.0_neutral__8wekyb3d8bbwe* | Remove-AppxPackage"
...
cls
	...
	echo Internet Connection Found! Proceeding...
		...
		@powershell -NoProfile -ExecutionPolicy Bypass -Command "choco install -y --force --allow-empty-checksums vlc 7zip open-shell jpegview vcredist-all directx chromium"
